...
class DML_:
    ...
    def get_delete_statement(self):
        ...
        # return """DELETE FROM {};""".format(MAIN_STAGING_TABLE_NAME)
    ...
    def run(self):
        # self.STATEMENTS["UPSERT_STATEMENT"] = self.upsert_statements()
        self.upsert_statements()
        # self.STATEMENTS["RAW_DATA_INSERT"]=  self.insert_raw_data()
        self.insert_raw_data()
        # self.STATEMENTS["COUNT_INSERT_STATEMENT"] =  self.insert_count()
        self.insert_count()
        # self.STATEMENTS["DELETE_QUERIES"] = self.get_delete_statement()
